...
import com.example.fowltyphoidmonitor.screens.FarmerReportsAdapter;
...
import com.example.fowltyphoidmonitor.screens.ReportDetailsActivity;
...
public class FarmerReportsActivity extends AppCompatActivity {
    ...
    private boolean isFarmer() {
        ...
        return USER_TYPE_FARMER.equals(userType);
    }

    private void redirectToLogin() {
        Intent intent = new Intent(FarmerReportsActivity.this, LoginActivity.class);
        ...
        if (bottomNavigation != null) {
            ...
            bottomNavigation.setOnItemSelectedListener(item -> {
                ...
                if (itemId == R.id.navigation_home) {
                    navigateToActivity(AdminMainActivity.class, "Home");
                    return true;
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(FarmerReportsActivity.this, AdminMainActivity.class);
