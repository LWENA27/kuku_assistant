...
public class DashboardManagerActivity {
    ...
    // Singleton instance
    private static com.example.fowltyphoidmonitor.screens.DashboardManagerActivity instance;

    // Dashboard data
    private DashboardData currentData;

    public static synchronized com.example.fowltyphoidmonitor.screens.DashboardManagerActivity getInstance(Context context) {
        if (instance == null) {
            instance = new com.example.fowltyphoidmonitor.screens.DashboardManagerActivity(context.getApplicationContext());
        }
        return instance;
    }
