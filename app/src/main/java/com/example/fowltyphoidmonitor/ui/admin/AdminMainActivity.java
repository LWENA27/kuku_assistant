...
import com.example.fowltyphoidmonitor.ui.admin.AdminSettingsActivity;
...
import com.example.fowltyphoidmonitor.ui.admin.ManageDiseaseInfoActivity;
import com.example.fowltyphoidmonitor.R;
import com.example.fowltyphoidmonitor.ui.admin.ReportAnalyticsActivity;
...
import com.example.fowltyphoidmonitor.ui.vet.ViewReportsActivity;
...
public class AdminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isProfileComplete()) {
            try {
                Log.d(TAG, "[LWENA27] Profile incomplete, redirecting to profile setup");
                if (isAdminOrVet()) {
                ...
                Log.e(TAG, "[LWENA27] Profile edit activity may not exist yet: " + e.getMessage());
            }
        }
    ...
    private void setupClickListeners() {
        ...
        // View Reports (use existing variable)
    ...
    private void userLogout() {
        try {
            ...
            editor.putBoolean("isAdminLoggedIn", false); // Clear admin login state from AdminLoginActivity
